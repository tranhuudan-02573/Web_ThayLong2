    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer d-flex justify-content-between">
                <span>Bạn chưa có tài khoản? <a href="/views/signup.jsp" class="text-danger">Đăng ký</a></span>
            ...
            <div class="row align-items-center ">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-12 d-none d-sm-block pl-1 pr-1">
                    <ul class="nav justify-content-end">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-center text-white " href="/views/user.jsp"><div><i class="fa-solid fa-clock-rotate-left fa-lg"></i></div>   lịch sử mua hàng</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link text-center text-white " href="/views/cart.jsp"> <div> <i class="fa fa-shopping-cart fa-lg" aria-hidden="true"></i></div>Giỏ hàng</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link text-center text-white " href="/views/user.jsp"><div><i class="fa fa-heart fa-lg" aria-hidden="true"></i></div> Sản phẩm đã thích</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-center text-white " href="/views/user.jsp" data-toggle="modal" data-target="#modalLoginForm">
        ...
        <div class="container">
            <ul class="nav row row-sm">
                <li class="nav-item ol-md-4 hvr-grow_color" >
                    <a class="nav-link text-white text-uppercase"href="/views/productlist.jsp"><i class="fa-solid fa-mobile-screen mr-2"></i></i></i>iPhone
                    </a>
                </li>
                <li class="nav-item ol-md-4 hvr-grow_color">
                    <a class="nav-link text-white text-uppercase" href="/views/productlist.jsp"><i class="fa-solid fa-mobile-screen mr-2"></i></i></i>SamSung
                    </a>
                </li>
                <li class="nav-item ol-md-4 hvr-grow_color">
                    <a class="nav-link text-white text-uppercase" href="/views/productlist.jsp"><i class="fa-solid fa-mobile-screen mr-2"></i></i></i>Oppo
                    </a>
                </li>
                <li class="nav-item ol-md-4 hvr-grow_color">
                    <a class="nav-link text-white text-uppercase" href="/views/productlist.jsp"><i class="fa-solid fa-mobile-screen mr-2"></i></i></i>Xiaomi
                    </a>
                </li>
                <li class="nav-item ol-md-4 hvr-grow_color">
                    <a class="nav-link text-white text-uppercase" href="/views/productlist.jsp"><i class="fa-solid fa-mobile-screen mr-2"></i></i></i>Vivo
                    </a>
                </li>
                <li class="nav-item ol-md-4 hvr-grow_color">
                    <a class="nav-link text-white text-uppercase" href="/views/productlist.jsp"><i class="fa-solid fa-mobile-screen mr-2"></i></i></i>Realme
                    </a>
                </li>
                <li class="nav-item ol-md-4 hvr-grow_color">
                    <a class="nav-link text-white text-uppercase" href="/views/productlist.jsp"><i class="fa-solid fa-mobile-screen mr-2"></i></i></i>Nokia
                    </a>
                </li>
                <li class="nav-item ol-md-4 hvr-grow_color">
                    <a class="nav-link text-white text-uppercase" href="/views/productlist.jsp"><i class="fa-solid fa-mobile-screen mr-2"></i></i></i>Itel
                    </a>
                </li>
                <li class="nav-item ol-md-4 hvr-grow_color">
                    <a class="nav-link text-white text-uppercase"  href="/views/productlist.jsp"><i class="fa-solid fa-mobile-screen mr-2"></i></i></i>Msstel
                    </a>
                </li>
