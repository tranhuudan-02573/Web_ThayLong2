...
public class OrderAdminFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        if (user != null &&user.getPermission().equals(Variable.Global.ADMIN.toString())&& user.get(Variable.Global.ORDER.toString()) != null) {
