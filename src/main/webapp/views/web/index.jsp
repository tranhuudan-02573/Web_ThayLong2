...
<html lang="en">
		...
		<div class="homecontent ">
			<div class="container ">
				<section class="homeslider py-5">
					<div class="row row-sm h-100 p-1">
							...
							<div class="homeslider-right">
								...
								<div class="news pt-1">
									<div class="d-flex justify-content-between align-items-center"><span
											...
											class="text-danger">xem them</a></div>
				...
				<section class="homecate d-none d-sm-block">
					<div class="card">
					...
					<div class="catebody">
						<div class="row w-100 mx-auto rounded-lg">
							<a class="border  hvr-glow" style="width:calc(100%/7) ; height: 100%;">
								<div class="p-1 ">
									<div class="picture mb-4 mx-auto " style="position:relative;  justify-content: center; align-items: center;
						border-radius: 50%;
				...
				<section class="my-5">
					...
					<div class="card">
						<div class="card-header p-0">
							<img src="https://cdn.tgdd.vn/2022/11/banner/Tagline-hotsale-1200x120-1.png" alt=""
	...
	-webkit-line-clamp: 2;font-size: 14px;">
							...
							<div class="text-center">
								<button class="btn btn-danger text-uppercase btn-md text-white px-5 ">xem tất
									cả</button>
							</div>
						</div>
					</div>
				...
				<!--end slider-->
				<div class="homeads my-2">
					<a href=""><img src="/images/Vui%20tuu%20truong.png" class="img-fluid w-100"></a>
				</div>
				<section class="homesale">
					<div class="catetitle">
						<h2 class="text-center"><a href=""><img src="/images/title.png"></a></h2>
						<div class="homesale-body">
							<div class="owl-carousel owl-theme">
								<div class="item">
									<div class="card border-0">
										<a href="" class="button hvr-icon-grow"><img src="/images/mob3.jpg"
												class="card-img-top img-fluid " alt="..."></a>
										<div class="card-body">
											<div class="sales">
												<span>Giảm 2.000.000 <sup>đ</sup></span>
											</div>
											<h3><a href="#" class="text-dark">Iphone X 64GB</a></h3>
											<div class="prices">
												<p class="price-sale font-weight-bold mb-0">20.990.000<sup>đ</sup></p>
												<p class="price-old mb-0"><del>22.990.000 <sup>đ</sup></del></p>
											</div>
											<p class="card-text my-1">
												...
												<i class="fa fa-star-o" aria-hidden="true"></i> (44 đánh giá)
											</p>
											<div class="text-homesale">
												Giảm thêm 300,000đ khi thanh toán 100% giá trị đơn hàng qua VNPay-QR
											</div>
										</div>
									</div>
								</div>
								<!--end item owl carausel-->
								<div class="item">
									<div class="card border-0">
										<a href=""><img src="/images/m1.png" class="card-img-top img-fluid"
                                                        alt="..."></a>
										<div class="card-body">
											<div class="sales">
												<span>Giảm 2.000.000 <sup>đ</sup></span>
								...
								<div class="item">
									<div class="card border-0">
										<a href=""><img src="/images/m2.jpg" class="card-img-top img-fluid"
                                                        alt="..."></a>
										<div class="card-body">
											<div class="sales">
												<span>Giảm 2.000.000 <sup>đ</sup></span>
								...
								<div class="item">
									<div class="card border-0">
										<a href=""><img src="/images/m3.jpg" class="card-img-top img-fluid"
                                                        alt="..."></a>
										<div class="card-body">
											<div class="sales">
												<span>Giảm 2.000.000 <sup>đ</sup></span>
								...
								<div class="item">
									<div class="card border-0">
										<a href=""><img src="/images/m4.jpg" class="card-img-top img-fluid"
                                                        alt="..."></a>
										<div class="card-body">
											<div class="sales">
												<span>Giảm 2.000.000 <sup>đ</sup></span>
								...
								<div class="item">
									<div class="card border-0">
										<a href=""><img src="/images/mb2.jpg" class="card-img-top img-fluid"
                                                        alt="..."></a>
										<div class="card-body">
											<div class="sales">
												<span>Giảm 2.000.000 <sup>đ</sup></span>
								...
								<div class="item">
									<div class="card border-0">
										<a href=""><img src="/images/mob3.jpg" class="card-img-top img-fluid"
                                                        alt="..."></a>
										<div class="card-body">
											<div class="sales">
												<span>Giảm 2.000.000 <sup>đ</sup></span>
								...
								<div class="item">
									<div class="card border-0">
										<a href=""><img src="/images/mbi1.jpg" class="card-img-top img-fluid"
                                                        alt="..."></a>
										<div class="card-body">
											<div class="sales">
												<span>Giảm 2.000.000 <sup>đ</sup></span>
				...
				<section class="card-phone d-block d-sm-none mt-3">
					<div class="row">
						<div class="col-4">
							<a href="#" title=""><img src="/images/egift%20(1).png" class="img-fluid"></a>
						</div>
						<div class="col-4">
							<a href="#" title=""><img src="/images/the-cao%20(1).png" class="img-fluid"></a>
						</div>
						<div class="col-4">
							<a href="#" title=""><img src="/images/sim-so%20(1).png" class="img-fluid"></a>
						</div>
					</div>
				</section>
				<!--end card-phone-->
				...
				<!--end news-->
				<section class="homecate d-none d-sm-block my-5">
					<div class="card">
						<div
							class="card-header white-text danger-color d-flex justify-content-between align-items-center">
							<h5 class="mt-2 text-uppercase font-weight-bold">xu hướng mua sắm</h5>
							<div>
								<button class="btn text-danger btn-outline-white btn-sm m-0 btn-rounded "><span class="h6">samsung</span></button>
									<button class="btn text-danger btn-outline-white btn-sm m-0  btn-rounded"><span class="h6">iphone</span></button>
									<button class="btn text-danger btn-white btn-sm m-0 btn-rounded"><span class="h6">xem tất
									cả</span></button>
							</div>
						</div>

					</div>
					<div class="catebody bg-light">
		<div class="row w-100 mx-auto  ">

						<div class="p-1" style="box-shadow: unset; width: 20%;">
										...
										<div class="d-flex flex-column h-100 w-100  ">
											...
											<a href="/views/web/product.jsp.jsp" class="text-dark">
												<div class="align-items-start cart-content  h-100">
													...
													<h3 class="text-ellipsis product-title overflow-hidden  mb-1 fw-normal  text-break " style="display: -webkit-box;
-webkit-box-orient: vertical;
-webkit-line-clamp: 2;font-size: 14px;">
...
-webkit-line-clamp: 2;font-size: 14px;">
	...
	-webkit-line-clamp: 2;font-size: 14px;">
				...
				<section class="my-5 tab-index bg-light p-4" >

<ul class="nav  nav-tabs row w-100 mx-auto" id="myTab" role="tablist" style="border: 0;">
								<li class="nav-item col-3 text-center" >
									<a class="nav-link  text-danger text-uppercase	 active " id="home-tab"
										data-toggle="tab" href="#tragop0" role="tab" aria-controls="home"
										aria-selected="true"> <span class="btn-floating btn-md  btn-default m-0 mr-2"style="box-shadow: none;"><i class="fas fa-bolt"></i></span>Trả góp 0%</a>



								</li>
								<li class="nav-item  col-3 text-center" >
									<a class="nav-link text-danger text-uppercase" id="hot-tab" data-toggle="tab"
										href="#hot" role="tab" aria-controls="profile" aria-selected="false"><span class="btn-floating btn-md  btn-default m-0 mr-2"style="box-shadow: none;"><i class="fas fa-bolt"></i></span>Sản phẩm
										hot</a>
								</li>
							<li class="nav-item col-3 text-center" >
									<a class="nav-link  text-danger text-uppercase " id="buyest-tab" data-toggle="tab" href="#buyest"
										role="tab" aria-controls="profile" aria-selected="false"><span class="btn-floating btn-md  btn-default m-0 mr-2"style="box-shadow: none;"><i class="fas fa-bolt"></i></span>Sản phẩm mua nhiều</a>
								</li>
								<li class="nav-item col-3 text-center"  >
									<a class="nav-link text-danger text-uppercase" id="sale-tab" data-toggle="tab" href="#discount"
										role="tab" aria-controls="profile" aria-selected="false"><span class="btn-floating btn-md  btn-default m-0 mr-2" style="box-shadow: none;"><i class="fas fa-bolt"></i></span>Sản phẩm ưu đãi </a>
								</li>
...
-webkit-line-clamp: 2;font-size: 14px;">
				...
				<section class="homecate d-none d-sm-block my-5">
					<div class="card">
						<div
							class="card-header text-danger d-flex justify-content-between align-items-center">
							<h5 class="mt-2 text-uppercase font-weight-bold">điện thoại hot</h5>
							<div>
								<button class="btn white-text btn-outline-danger btn-sm m-0 btn-rounded "><span class="h6">samsung</span></button>
									<button class="btn white-text btn-outline-danger btn-sm m-0  btn-rounded"><span class="h6">iphone</span></button>
									<button class="btn white-text btn-danger btn-sm m-0 btn-rounded"><span class="h6">xem tất
									cả</span></button>
							</div>
						</div>
						<div class="card-body bg-light">
  ...
  <a href="" >  <img class="owl-lazy border border-danger" style="border-width: 2px !important;" data-src="/images/egift.png" data-src-retina="/images/egift.png" alt=""></a>
  <a href="" > <img class="owl-lazy border border-danger" style="border-width: 2px !important;" data-src="/images/the-cao.png" data-src-retina="/images/the-cao.png" alt=""></a>
   <a href="" >    <img class="owl-lazy border border-danger" style="border-width: 2px !important;" data-src="/images/sim-so.png" data-src-retina="/images/sim-so.png" alt=""></a>
