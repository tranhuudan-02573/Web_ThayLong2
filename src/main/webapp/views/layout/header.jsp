                ...
                <div class="row align-items-center ">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-12 d-none d-sm-block pl-1 pr-1">
                        <ul class="nav justify-content-end">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-center text-white " href="/views/user.jsp">
                                    <div><i class="fa-solid fa-clock-rotate-left fa-lg"></i></div>
                                    lịch sử mua hàng</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link text-center text-white " href="/views/cart.jsp">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-center text-white " href="/views/user.jsp" data-toggle="modal"
            ...
            <div class="container">
                <ul class="nav row row-sm">
                    <li class="nav-item ol-md-4 hvr-grow_color">
                        <a class="nav-link text-white text-uppercase" href="/views/productlist.jsp"><i
