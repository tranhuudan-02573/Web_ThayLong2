                        ...
                        <li class="step active">
                            ...
                            <div class="step-new-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9"><select class="mdb-select md-form" editable="true"
                                    ...
                                    <div class="col-9"><textarea id="textarea-char-counter"
                                                                 class="form-control md-textarea" length="120"
                                                                 rows="3"></textarea>
                            ...
                            <div class="step-new-content">
                                <div class="px-4">
                                    <div class="row align-items-center ">
                                        ...
                                        <div class="col-3"><input id="input-char-counter1" type="number" length="10"
                                                                  class="form-control">
                                    ...
                                    <div class="row  align-items-center ">
                                        <div class="col-4">
                                            <div class="form-check  ">
                                                <input type="checkbox" class="form-check-input" id="materialChecked2"
                                                       checked>
                                                <label class="form-check-label" for="materialChecked2">trả góp
                                                    0%</label>
                                            </div>
                                        </div>
                                        <div class="col-4">
