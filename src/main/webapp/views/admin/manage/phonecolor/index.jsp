  ...
  <div class="modal-dialog-scrollable modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="" class="btn btn-default">chỉnh sửa</a>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="table-wrapper">
      ...
      <table id="detail" class="table border table-hover mb-0">
        ...
        <%
            ...
            List<PhoneColor> colors  =(   List<PhoneColor> ) request.getAttribute("colors");
        ...
        %>
          ...
          <tr>
            <th scope="row">
              <input class="form-check-input" type="checkbox" id="checkbox-<%=colors.get(i).getPhoneId()%>">
              <label class="form-check-label" for="checkbox-<%=colors.get(i).getPhoneId()%>" class="label-table"></label>
            </th>
            <td><%=i%></td>
             <td><%=colors.get(i)._phone()._cap().getCap()%><%=colors.get(i)._phone()._cap().getUnit()%></td>
              <td> <%=colors.get(i)._phone()._cap().getCap()%><%=colors.get(i)._phone()._cap().getUnit()%></td>
            <td><%=colors.get(i).total()%></td>
              <td><%=colors.get(i).getCreated_at()%> <br/> <%=colors.get(i).getUpdated_at()%></td>

            <td>
              <a href=""><i class="fa-regular fa-eye"></i></a>
              <a href="/admin/manage/phonecolor/edit<%=colors.get(i).getPhoneId()%>"><i class="far fa-edit"></i></a>
