                    ...
                    <div class="table-wrapper">
                        ...
                        <table id="detail" class="table border table-hover mb-0">
                            ...
                            <tr>
                                ...
                                <td><%=promots.get(i).getId()%>
                                </td>
                                <td><%=promots.get(i).getName()%>
                                </td>
                                <td><%=promots.get(i).getKey()%>
                                </td>
                                <td><%=promots.get(i).getUpdated_at()%>
                                </td>
                                <td>
                                    <a><i val="<%=promots.get(i).getId()%>"
                                          class="fa-regular fa-eye"></i></a>
                                    <a href="/admin/manage/promot/edit?id=<%=promots.get(i).getId()%>"><i
        ...
        $(document).ready(function () {
            ...
            function view(id) {
                $.ajax({
                    ...
                    $('#viewDetail #edit').attr('href', '/admin/manage/promot/edit?id=' + responseText.id);
