...
<div class="card card-cascade narrower">
 ...
 <input id="phone" type="text" length="10" class="form-control">
...
<div class="form-check form-check-inline">
  <input type="radio" class="form-check-input" id="gender2" name="inlineMaterialRadiosExample">
  <label class="form-check-label" for="gender2">Nam</label>
</div>

<!-- Material inline 3 -->
<div class="form-check form-check-inline">
  <input type="radio" class="form-check-input" id="gender1" name="inlineMaterialRadiosExample">
  <label class="form-check-label" for="gender1">Nữ</label>
</div>
