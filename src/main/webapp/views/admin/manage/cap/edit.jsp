  ...
  <div class="px-4">
    ...
    <div class="table-wrapper">
     ...
     <table class="table table-hover border">
          ...
          <tbody>
<form action="/admin/manage/cap/edit" method="post" id="form">
              <tr>
              <th>Cap</th>
                 <td><!-- Material outline counter input -->
 <input id="cap" type="text" length="10" class="form-control" value="<%=cap.getCap()%>">
  <label for="cap"></label>
            </tr>
                 <tr>
              <th>Unit</th>
               <td> <input id="unit" type="text" length="10" class="form-control" value="<%=cap.getUnit()%>">
