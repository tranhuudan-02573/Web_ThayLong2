...
<%
    List<Cap> listCap = (List<Cap>) request.getAttribute("caps");
%>
<!--Double navigation-->
    ...
    <div class="modal-dialog modal-notify modal-warning" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <p class="heading lead text-uppercase">thêm cap</p>
            ...
            <form id="form">            <!--Body-->
                <div class="modal-body">
                    <table class="table table-hover border">
                        ...
                        <tr>
                            <th>cap</th>
                            <td><input id="cap"  type="number" data-value-type="number" name="cap" class="form-control">
                                <label for="cap"></label></td>
                        </tr>
                        <tr>
                            <th>unit</th>
            ...
            <div class="modal-footer justify-content-center">
                <a type="button" onclick="$('form#form').submit()"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <table class="table table-hover border">
                                    ...
                                    <tr>
                                        <th>cap</th>
                                        <td class="font-weight-normal align-left-10 detail-cap"></td>
                                    </tr>
                                    <tr>
                                        <th>unit</th>
                            ...
                            <div class="modal-footer">
                                <button type="button" id="delete" val="" class="btn btn-outline-default text-uppercase"
                                >xóa
                                </button>
                    ...
                    <div class="table-wrapper">
                        ...
                        <table id="detail" class="table border table-hover mb-0">
                            ...
                            <tr>
                                ...
                                <td><%= listCap.get(i).getId()%>
                                </td>
                                <td><%= listCap.get(i).getCap()%>
                                </td>
                                <td><%= listCap.get(i).getCreated_at()%>
                                </td>
                                <td><%= listCap.get(i).getUpdated_at()%>
                                </td>
                                <td>
                                    <a><i val="<%=listCap.get(i).getId()%>" class="fa-regular fa-eye"></i></a>
                                    <a href="/admin/manage/cap/edit?id=<%=listCap.get(i).getId()%>"><i
                                            class="far fa-edit"></i></a>

                                    <a><i val="<%=listCap.get(i).getId()%>" class="far fa-trash-alt"></i></a>
                                </td>
...
<content tag="local_script">
    ...
    <script>
        $(document).ready(function () {
            ...
            function view(id) {
                $.ajax({
                    type: 'GET', url: "/api/cap" + "?id=" + id


                }).done(function (responseText) {
                    $('#viewDetail').modal();
                    $('#viewDetail .detail-id').text(responseText.id);
                    $('#viewDetail .detail-cap').text(responseText.cap);
                    ...
                    $('#viewDetail #edit').attr('href', '/admin/manage/cap/edit?id=' + responseText.id);
