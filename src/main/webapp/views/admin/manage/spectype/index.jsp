                    ...
                    <div class="table-wrapper">
                        ...
                        <table id="detail" class="table border table-hover mb-0">
                            ...
                            <tr>
                                ...
                                <td><%=specTypes.get(i).getId()%>
                                </td>
                                <td><%=specTypes.get(i).getName()%>
                                </td>
                                <td><%=specTypes.get(i).getKey()%>
                                </td>
                                <td><%=specTypes.get(i).getUpdated_at()%>
                                </td>
                                <td>
                                    <a><i val="<%=specTypes.get(i).getId()%>"
                                          class="fa-regular fa-eye"></i></a>
                                    <a href="/admin/manage/spectype/edit?id=<%=specTypes.get(i).getId()%>"><i
                                            class="far fa-edit"></i></a>

                                    <a><i val="<%=specTypes.get(i).getId()%>"
                                          class="far fa-trash-alt"></i></a>
                                    <a href="/admin/manage/spectype?id=<%=specTypes.get(i).getId()%>">
                                        <i class="fa-solid fa-up-right-from-square mr-1"></i></a>
                                </td>
...
<content tag="local_script">
    ...
    <script>
        $(document).ready(function () {
            ...
            function view(id) {
                $.ajax({
                    type: 'GET', url: "/api/spec-type" + "?id=" + id
                    ...
                    $('#viewDetail #edit').attr('href', '/admin/manage/spectype/edit?id=' + responseText.id);
