...
<%
    SpecType specType = (SpecType) request.getAttribute("specT");
%>
<!--Double navigation-->
<!--/.Double navigation-->
                                ...
                                <tr>
                                    ...
                                    <td><!-- Material outline counter input -->
                                        <input id="name" type="text" name="name" class="form-control"
                                               value="<%=(specType.getName()!=null)?specType.getName():""%>">
                                        <label for="name"></label>
                                </tr>
                                <tr>
                                    <th>key</th>
                                    <td><input id="key" type="text" name="key" class="form-control"
                                               value="<%=(specType.getKey()!=null)?specType.getKey():""%>">
