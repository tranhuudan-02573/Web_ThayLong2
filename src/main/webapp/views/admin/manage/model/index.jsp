        ...
        <div id="container">
            ...
            <div class="card card-cascade narrower">
                ...
                <div
                    ...
                    <a href="" class="white-text mx-3 text-uppercase ">danh sách kiểu</a>
                    ...
                    <div class="table-wrapper">
                        ...
                        <table id="detail" class="table border table-hover mb-0">
                            ...
                            <tr>
                                ...
                                <td><%=listModel.get(i).getId()%>
                                </td>
                                <td><%=listModel.get(i).getName()%>
                                </td>
                                <td><img style="height: 50px;" src="<%=listModel.get(i).getImg()%>"></td>
